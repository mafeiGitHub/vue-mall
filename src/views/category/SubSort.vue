<template>
  <div class="sub-sort">
    ...
    <div class="check">
      <CheckBox @change="changeCheck" v-model="sortParams.inventory">仅显示是有货商品</CheckBox>
      <CheckBox @change="changeCheck" v-model="sortParams.onlyDiscount">仅显示特惠商品</CheckBox>
    </div>
  </div>
</template>
